...
//装备的信息面板
public class ShopItemMessage : MonoBehaviour {
    ...
    private void Awake()
    {
        ...
        //_diamond = this.transform.Find("Diamond").GetComponent<Text>();
    ...
    public void RefreshItemDate(int id)
    {
        ...
        _price.text = "价格(钻):" + itemData.item_Diamond.ToString();
        ...
        _res.text = "";
        _def.text = "";
        //_diamond.text = itemData.item_Diamond.ToString();
