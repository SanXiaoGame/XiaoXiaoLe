...
//显示酒馆可以招募的三个角色
public class ShopCharacterShow : MonoBehaviour {
    Image _character1;
    Image _character2;
    Image _character3;
    int _id1;
    ...
    private void Awake()
    {
        ...
        characterMessage = GameObject.FindGameObjectWithTag("ShopTopBtn").GetComponent<ShopTopBtn>().characterMessage;
            ...
            characterMessage.GetComponent<ShopCharacterMessage>().ShowCharacterMesaage(_id1,type);
        ...
        this.transform.Find("Character2").GetComponent<Toggle>().onValueChanged.AddListener((isOn) => {
            ...
            characterMessage.SetActive(true);
            characterMessage.GetComponent<ShopCharacterMessage>().ShowCharacterMesaage(_id2,"2级普通");
        ...
        this.transform.Find("Character3").GetComponent<Toggle>().onValueChanged.AddListener((isOn) => {
            ...
            characterMessage.SetActive(true);
            characterMessage.GetComponent<ShopCharacterMessage>().ShowCharacterMesaage(_id3,"2级稀有");
