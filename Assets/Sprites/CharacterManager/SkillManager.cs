...
public class SkillManager : MonoBehaviour {
    ...
    public void RefreshSkill(int ID) {
        skill1 = SQLiteManager.Instance.characterDataSource[ID].character_SkillOneID;
        skill2 = SQLiteManager.Instance.characterDataSource[ID].character_SkillTwoID;
        skill3 = SQLiteManager.Instance.characterDataSource[ID].character_SkillThreeID;
        string pathSkill1 = string.Format("Texture/Icon0/{0}", skill1);
        string pathSkill2 = string.Format("Texture/Icon0/{0}", skill2);
        string pathSkill3 = string.Format("Texture/Icon0/{0}", skill3);
    ...
    private void Awake()
    {
        ...
        GameObject skillProproty = this.transform.Find("SkillProprety").gameObject;
