...
public class CharacterProprety : MonoBehaviour {
    ...
    internal Text AD { get; set; }//角色的AD
   
    internal Text AP { get; set; }//角色的AP
    
    internal Text HP { get; set; }//角色的HP
   
    internal Text RES { get; set; }//角色的RES
    
    internal Text DEF { get; set; }//角色的DEF
    ...
    public void RefreshCharacterProprety(int id)
    {
        ...
        HeroData hero = SQLiteManager.Instance.team[id];
